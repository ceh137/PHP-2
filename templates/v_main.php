        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?act=catalog">Catalog</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        if (isset($_SESSION['user'])) { ?>
                            <?= "<a class='nav-link' href='index.php?act=account'>Личный кабинет</a>" . "<a class='nav-link' href='index.php?act=cart'>Корзина</a>" ?>
                        <?php } else { ?>
